import { getDataForDate, getDataForMonth, getDataForYear } from "../../utils/chart_filters/functions_stage3";
import { IChartData, TDate } from "../../utils/types/chart_type";

export const chartFunction_Stage3 = async ({ currentDate, settings }: IChartData) => {
