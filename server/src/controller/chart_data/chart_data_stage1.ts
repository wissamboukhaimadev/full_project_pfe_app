import { getDataForDate, getDataForMonth, getDataForYear } from "../../utils/chart_filters/functions_stage1";
import { IChartData, TDate } from "../../utils/types/chart_type";

export const chartFunction_Stage1 = async ({ currentDate, settings }: IChartData) => {
