...
export default function CardsGeneral({ global_data }: TCartdGeneral) {

    const { tension, current, puissance_active, puissance_apparente, puissance_reactive, energy } = global_data
    return (
        <>
