...
export default function CardsEtage1({ stage1_data }: TCartdStage1) {

    const { tension, current, puissance_active, puissance_apparente, puissance_reactive, energy } = stage1_data
    return (
        <>
            <motion.div
