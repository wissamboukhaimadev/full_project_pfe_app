...
export default function CardsEtage3({ stage3_data }: TCartdStage3) {

    const { tension, current, puissance_active, puissance_apparente, puissance_reactive, energy } = stage3_data
    return (
        <>
            <motion.div
